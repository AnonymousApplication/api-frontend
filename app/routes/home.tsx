...
export default function Home() {
    ...
    return (
        <Container className="p-3" fluid>
            <Row>
                <Col>
                    <Navbar className="mb-2 ps-2 brand">
                        ...
                        <Navbar.Brand className="ms-2 brand">
                            Task Manager
                        </Navbar.Brand>
                        <Pagination aria-label="Task pagination" className="mb-0 me-2 ms-auto" data-intro="Navigate through the pages of tasks with these controls." data-step="2">
                            {first_link && 
            ...
            <Row>
                <Col>
                    <Table 
                        data-intro="Your tasks. Select a row to edit a task." data-step="1" 
            ...
            <Row>
                <Col>
                    <Nav.Link href="task" data-intro="Add a new task." data-step="3" className="d-grid">
                        <Button aria-label="Add button">Add task</Button>
                    </Nav.Link>  
                </Col>
            </Row>
        </Container>
